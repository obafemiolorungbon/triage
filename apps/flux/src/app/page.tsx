      ...
      <main className="relative mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-10 px-6 pb-20 pt-32 lg:grid-cols-[0.85fr_1.15fr]">
        <section>
          ...
          <p className="mt-6 max-w-xl text-lg leading-8 text-paper-400">
            ...
            with company context, and now lets staff ask the queue what changed,
            what is still open, and which records support the answer.
          </p>
        ...
        <section className="surface-raised overflow-hidden rounded-[28px]">
          ...
          <div className="grid min-h-[460px] grid-cols-[150px_1fr]">
            <aside className="border-r border-paper-100/[0.075] p-5 text-sm text-paper-500">
              ...
              <span className="pill mb-2">Ask</span>
            ...
            <div className="p-5">
              <div className="mb-5 grid grid-cols-3 gap-3">
                {[
                  ...
                  <div
                    key={label}
                    className="rounded-2xl bg-paper-100/[0.04] p-4 ring-1 ring-paper-100/[0.06]"
                  >
                    <p className="font-mono text-2xs uppercase tracking-wider text-paper-500">
                      {label}
                    </p>
                    <strong className="mt-2 block font-mono text-2xl text-paper-50">
                      {value}
                    </strong>
                  </div>
                ))}
              ...
              {[
                ...
                ['ask', 'cited', 'Top open issues this week'],
              ].map(([meta, tier, title]) => (
                <div
                  key={title}
                  className="border-t border-paper-100/[0.06] py-4"
                >
